+++
title = "20260420 Two if by Sea2"
date = "2026-04-16T08:03:27-05:00"
#dateFormat = "2006-01-02" # This value can be configured for per-post date formatting
author = ""
authorTwitter = "" #do not include @
cover = ""
tags = ['miniatures', 'painting', 'contest']
keywords = ["", ""]
description = ""
...
I suppose that's not entirely fair. Over the course of a couple days, I had a good think, built a couple models, and decided "I can mull this over and figure out what I want to paint for this event later, it's late next month." Instead, turns out it was mid-_this_-month, which means I already burned a couple days messing around with the painting for the second event, which I knew _for certain_ was at the end of April.
...
![Necromunda Ambot](/images/contests/ambot1.jpg "Ambot") 
...
Battle damage meant I got to utilize one of my favorite tools: Trogdor

![Trogdor](/images/contests/trogdor.jpg "Trogdor") 

A simple paperclip glued into a cork, its use is also deceptively simple: heat it up with a lighter until it's red hot, then use it to make bullet holes and gashes on plastic minis. Battle damage is one of those things where you have to be sure not to go overboard, but I made a couple specifically placed holes and gashes on the Ambot, such as on the hazard stripes. It's also hard to see in the first image, but I scraped one of the "nubs" off the shoulder shield for additional damage.  

![Necromunda Ambot](/images/contests/ambot2.jpg "Ambot") 

While it wasn't the immediate intent, I did also paint the hazard stripes freehand, instead of using Tamiya masking tape like I normally do. This was in part due to the battle damange and in part due to the curved surface - I didn't take enough math to figure out how work the curve. Another aspect of "pushing myself out of my comfort zone" with this model. It also has some shading, though I didn't push that element as far as I could have (and would on a subsequent model, below).

![Necromunda Ambot](/images/contests/ambot3.jpg "Ambot")

Between the large, flat areas on the model and not wanting to wash out the weathering effects, I opted to not utilize my default process of "throw a wash at it" and instead go for (some) lowlights and edge highlighting. This really made me realize how much I rely on washes to hide certain imperfections. 

I ended up finding that some of the lowlighting wasn't intense enough to see well at "tabletop distance". Up to my face I could see where the "shadows" were based on the lowlight colors, but they were very subtle. 

![Necromunda Ambot](/images/contests/ambot4.jpg "Ambot")
![Necromunda Ambot](/images/contests/ambot5.jpg "Ambot")

The rust was fun to do - I used a slightly different process this time, and while only hitting a few key spots on the model itself, used it liberally on the base. Usually for Necromunda bases I include some hazard stripes (because there's no good place to put hazards on a Delaque ganger) I instead opted to just do a heavy oil stain and rust base, to give it a little brown-orange tint to make the blue Ambot pop more.
...
- Blending needs work. This was a little bit of a wake up call - I feel like I used to be good at that, back when I painted Warmahordes (over _ten years ago_) but haven't realy used it much.
- I also need to not be afraid to push highlights and lowlights. I kept finding that some instances blended "too well" to the eye at any distance - which I suppose is a sign that the colors are supposed to blend well, but they didn't always register as "highlights."
...
- When you decide to participate in something, _make sure you know when the event takes place._ 

Ultimately I'm happy with how it turned out. Certainly I can see parts where I know I could push an element further, but I suppose that's natural when I've been holding the thing inches from my face for over a week.

<iframe title="Necromunda - Ambot Sizzle" width="560" height="315" src="https://makertube.net/videos/embed/ooGvw1KQ3uCP5JgXLWC2aA" allow="fullscreen" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" style="border: 0px;"></iframe>
...
Bottom line: never got to play WHFB. Flash forward to 2021(or 2022? time has no meaning post-2020) when I got into 40k. It wasn't immediate, but I started to toy around with getting some Skaven, finally. But in learning everything that transpired between WHFB End of Times and the introduction of Age of Sigmar, I was crestfallen to find that Ikit Claw, my absolute favorite character, didn't exist anymore. I mean, he invented the Doomwheel! And he was just deleted from the canon.

![The real Ikit Claw (4th edition)](/images/contests/realikit.jpg "The real Ikit Claw (4th edition)")

###### Ikit 2.0

So I took it upon myself to build an Ikit Claw (because I sure as shit wasn't going to pay eBay prices (okay looking now they're not actually that expensive. Guess the Ikit Claw bubble, like all good Skaven inventions, burst)). So I took an old metal Warlord Claw Leader, slapped a Space Marine pack, a Lightning Claw Power Fist ... _thing_, and a spare Skaven Clanrat banner on him and, voilà, a true Skryre horror:

![Ikit kitbash](/images/contests/Ikit1.jpg "Ikit Kitbash")
![Ikit kitbash](/images/contests/Ikit2.jpg "Ikit kitbash")
...
Inititally I had given the model _even more red_, trying to lean into a comment from a [Warhammer Community article ](https://www.warhammer-community.com/en-gb/articles/s2QKg3Io/40-years-of-warhammer-from-retro-painting-to-modern-day-masterclasses/) that mentions 

>Red was the chief accent colour of choice [...]

so by god this rat was going to have red. Initially the shawl/collar/thing was also red, but that created a visual issue where, from the front the shoulders just melded into the backpack. Highlights _might_ have fixed that, but I didn't want to chance it. Plus, changing it to black better mirrors the original Ikit Claw model with the black robes and hood.

![Ikit kitbash mistake](/images/contests/ikit3.jpeg "Ikit kitbash with too much red")
...
Expanding on the hazard stripes from the Ambot, I wanted to force myself to do more freehanding since there was this nice, big flag. And why not add blending into that mix too? I wanted to avoid the standard Skaven triangle on the front because it was already on the flagpole, so I went with claw marks, blending from highlights to lowlights.

![Ikit kitbash](/images/contests/Ikit5.jpg "Ikit kitbash")

And of course, the Goblin Green base. Like any good rug, it ties the room together.
