+++
title = "20260418 Two if by Sea"
date = "2026-04-18T09:30:06-05:00"
...
Admittedly the Ambot was initially just one of those "I _could_ paint this for the event" models but after realizing I was already a few days behind, I just committed to the bit and went with it.
...
Bottom line: never got to play WHFB. Flash forward to 2021(or 2022? time has no meaning post-2020) when I got into 40k. It wasn't immediate, but I started to toy around with getting some Skaven, finally. (Years before, when I played Warmahordes and already had that toe in the hobbying ... hobby, I had actually bought the Isle of Blood box set (because _Skaven_), assembled it, and painted a few. But now I had people who I could actually play with.) But in learning everything that transpired between WHFB End of Times and the introduction of Age of Sigmar, I was crestfallen to find that Ikit Claw, my absolute favorite character, didn't exist anymore. I mean, he invented the Doomwheel! And he was just deleted from the canon.

![The real Ikit Claw (4th edition)](/images/contests/realikit.jpg "The real Ikit Claw (4th edition)")

###### Ikit 2.0

So I took it upon myself to build an Ikit Claw (because I sure as shit wasn't going to pay eBay prices (okay looking now they're not actually that expensive. Guess the Ikit Claw bubble, like all good Skaven inventions, burst)). So I took an old metal Warlord Claw Leader, slapped on a Space Marine pack, a Lightning Claw Power Fist ... _thing_, and a spare Skaven Clanrat banner and, voilà, a true Skryre horror:
...
Inititally I had given the model _even more red_, trying to lean into a comment from a [Warhammer Community article ](https://www.warhammer-community.com/en-gb/articles/s2QKg3Io/40-years-of-warhammer-from-retro-painting-to-modern-day-masterclasses/) describing 'Eavy Metal through the years that mentions 
...
![Ikit kitbash](/images/contests/flag.jpg "Ikit kitbash")
