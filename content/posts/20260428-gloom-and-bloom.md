+++
title = "20260428 Gloom and Bloom"
date = "2026-04-28T20:49:12-05:00"
#dateFormat = "2006-01-02" # This value can be configured for per-post date formatting
author = ""
authorTwitter = "" #do not include @
cover = ""
tags = ['miniatures', 'painting', 'contest', 'blood bowl']
keywords = ["", ""]
description = ""
...
The April painting theme being "Bloom and Decay," or bloom _or_ decay, or bloom and decay and there and back again, I opted to incorporate both decay and bloom in this Blood Bowl Treeman - both the slow decay of a dying tree, the blooming of new flowers on the base, and the cycle of death and regrowth through the changing of the leaves. (That's three "boths" but stick with me here.)

<!--more-->

![Treeman](/images/treeman/treeman2.jpg "Gnome Treeman")

For the trunk I wanted to lean into the decay - old, dark, dead wood. It's different than my normal wooden-things recipe, and a combination of a couple things I found from a ~~Citadel~~ _Warhammer How To Paint Miniatures_ guide and some Paintpad.app recipes. I also wanted to keep it dark in order for the leaves and flowers to pop more. I didn't want everything to get lost in the mid-tone shuffle. 
...
![Treeman](/images/treeman/treeman1.jpg "Gnome Treeman")
...
![Treeman](/images/treeman/treeman3.jpg "Gnome Treeman")
...
![Treeman](/images/treeman/wrongcolors.jpeg "Gnome Treeman")

The purple in the shoe was specifically to pop some color against the rest of the paint scheme. I don't have a purple Blood Bowl team and I don't really plan on it for any of my future teams (Brets and TKs). Speaking of washes, I wanted to give the shoe a bit of definition and grime, but without going as hard in the paint as I do with my Skablins using [Agrax over Ulthuan](https://blog.floppy.parts/posts/20260118-end-of-the-line/) so first trying the above Flesh Tone wash, I realized it was too North Carolina Dirt red/orange. Not the look I'm going for, for an aged shoe in a tree. So instead I took what I immediately learned from watering down Flesh Tone and watered down Agrax. The result? It's _fine_. 

Anyway, here it is in action.

<iframe title="Blood Bowl Gnome Treeman Sizzle" width="560" height="315" src="https://makertube.net/videos/embed/kJatFbuSAHcXJFVPkfcegE" allow="fullscreen" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" style="border: 0px;"></iframe>
